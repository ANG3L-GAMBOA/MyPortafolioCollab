...
Me llamo Juan Ángel. Empecé en la
      programación de manera de curiosa sobre como funcionan las cosas, tenía 16. Actualmente soy. <strong>Egresado de la carrera tecnica de Dessarrollo de softwarte</strong>.
</p> <p>
...
+1 años de experiencia. <strong>Desarrollador de Software</strong> de Lima, Perú 🇵🇪. Especializado en el desarrollo de Backend.
